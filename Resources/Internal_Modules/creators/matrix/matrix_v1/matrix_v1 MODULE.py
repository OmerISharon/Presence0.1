...
def generate_video(
    ...
    font_size,
    font_effect,
    transparent_overlay_effect_color,
    text_remover_style,
    text_appearance_style,
    keep_last_segment,
    pause_time,
    gap_pause,
    gap_pause_last_segment,
    typing_speed,
    fps,
    is_short,
    enable_cursor_line,
    typing_sounds_dir,
    typing_sounds_volume,
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    # --- Colours / font ---
    parser.add_argument("--fore_color", default="255,0,0")
    parser.add_argument("--bg_color", default="0,0,0")
    parser.add_argument("--font_path", default=r"C:\\Windows\\Fonts\\ariblk.ttf")
    parser.add_argument("--font_size", type=int, default=40)
    parser.add_argument("--font_effect", default="")
    parser.add_argument("--transparent_overlay_effect_color", default="255,255,255,128")

    # --- Behaviour ---
    parser.add_argument("--text_remover_style", default="backspace")
    parser.add_argument("--text_appearance_style", default="type", choices=["type", "fade"])
    parser.add_argument("--keep_last_segment", type=lambda s: s.lower() in {"true", "1", "yes"}, default=False)

    # --- Timing ---
    parser.add_argument("--pause_time", type=float, default=1.0)
    parser.add_argument("--gap_pause", type=float, default=1.0)
    parser.add_argument("--gap_pause_last_segment", type=float, default=1.0)
    parser.add_argument("--typing_speed", type=float, default=0.05)
    parser.add_argument("--fps", type=int, default=30)
    parser.add_argument("--is_short", type=lambda s: s.lower() in {"true", "1", "yes"}, default=True)
    parser.add_argument("--enable_cursor_line", type=lambda s: s.lower() in {"true", "1", "yes"}, default=False)

    # --- Sounds ---
    parser.add_argument("--typing_sounds_dir", default=None)
    parser.add_argument("--typing_sounds_volume", type=float, default=1.0)
    parser.add_argument("--background_audio_path", default=None)
    parser.add_argument("--background_audio_volume", type=float, default=1.0)

    # --- TTS ---
    parser.add_argument("--enable_tts", type=lambda s: s.lower() in {"true", "1", "yes"}, default=False)
    ...
    # --- Background / media ---
    parser.add_argument("--media_paths", nargs="*", default=None)
    ...
    # --- Misc ---
    parser.add_argument("--separate_by_comma", type=lambda s: s.lower() in {"true", "1", "yes"}, default=True)
